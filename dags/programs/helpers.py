...
def helpers():
    ...
    variable_name_list = ["in_app_purchase_log_server_columns","in_app_purchase_log_server_columns_type","in_app_purchase_log_server_dict","login_columns","login_column_types","login_dict","multiplayer_battle_started_columns","multiplayer_battle_started_column_types","multiplayer_battle_started_dict","new_user_columns","new_user_column_types","new_user_dict","session_started_columns","session_started_column_types","session_started_dict","ship_transaction_log_columns","ship_transaction_log_column_types","ship_transaction_log_dict","table_names_list"]
    ...
    # return in_app_purchase_log_server_columns,in_app_purchase_log_server_columns_type,in_app_purchase_log_server_dict,login_columns,login_column_types,login_dict,multiplayer_battle_started_columns,multiplayer_battle_started_column_types,multiplayer_battle_started_dict,new_user_columns,new_user_column_types,new_user_dict,session_started_columns,session_started_column_types,session_started_dict,ship_transaction_log_columns,ship_transaction_log_column_types,ship_transaction_log_dict,table_names_list
